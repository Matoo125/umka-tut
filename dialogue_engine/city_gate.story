...
node: name_lena
speaker: Guard
text: Lena? I know that name. Your current trust is {trust}. What is your business in the city?
choice: Trade.|gate
...
node: ending_welcome
ending
ending_text: You earned a warm welcome with trust {trust}.
endnode

node: ending_jail
ending
ending_text: Your journey stops at the city jail.
endnode

node: ending_leave
ending
ending_text: You leave the gate behind and try elsewhere.
endnode
